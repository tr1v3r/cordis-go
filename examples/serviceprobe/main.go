...
func main() {
	...
	cordis.Load(rootCtx, cordis.Define[struct{}]("self", func(ctx *cordis.Context, _ struct{}) error {
		me := &db{"self"}
	...
	providerFiberA, _ := cordis.Load(rootCtx, cordis.Define[struct{}]("owner-a", func(ctx *cordis.Context, _ struct{}) error {
		_, err := cordis.Provide[*db](ctx, "db", &db{"A"})
		return err
	}), struct{}{})
	duplicateProviderFiber, err := cordis.Load(rootCtx, cordis.Define[struct{}]("owner-b", func(ctx *cordis.Context, _ struct{}) error {
	...
	runs := 0
	dependentFiber, _ := cordis.Load(rootCtx, cordis.Define[struct{}]("dependent", func(ctx *cordis.Context, _ struct{}) error {
		runs++
	...
	cordis.Load(rootCtx, cordis.Define[struct{}]("owner-a2", func(ctx *cordis.Context, _ struct{}) error {
	...
	cordis.Load(rootCtx, cordis.Define[struct{}]("cache", func(ctx *cordis.Context, _ struct{}) error {
		cacheCtx = ctx
		_, err := cordis.Provide[*db](ctx, "cached", &db{"v1"})
		return err
	}), struct{}{})
	consumed := 0
	cordis.Load(rootCtx, cordis.Define[struct{}]("consumer", func(ctx *cordis.Context, _ struct{}) error {
		consumed++
		return nil
	...
	cordis.Load(rootCtx, cordis.Define[struct{}]("flaky", func(ctx *cordis.Context, _ struct{}) error {
		flakyCtx = ctx
		_, err := cordis.ProvideChecked[*db](ctx, "flaky", &db{"f"}, func() bool { return ready.Load() })
		return err
	}), struct{}{})
	waiterFiber, _ := cordis.Load(rootCtx, cordis.Define[struct{}]("waiter", func(ctx *cordis.Context, _ struct{}) error {
	...
	greeterFiber, _ := cordis.Load(rootCtx, cordis.Define[struct{}]("greeter", func(ctx *cordis.Context, _ struct{}) error {
